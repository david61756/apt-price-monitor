...
3. **"GitHub에 저장"** → config.yaml이 자동 커밋되고 다음 자동 실행부터 반영
4. 바로 반영하려면 **"모니터링 지금 실행"** 클릭 (1~2분 후 새로고침)

토큰 없이 쓰려면 **"YAML 복사"** 후 GitHub에서 config.yaml에 붙여넣거나,
**"GitHub에서 직접 편집"** 링크를 이용하세요.
